...
const faqs = [
  { q: "Where is Nexus located in Islamabad?", a: "We're in the heart of F-7 Markaz with quick access from Margalla Road and Jinnah Avenue. Covered parking and a dedicated entry for members." },
