...
export function Hero() {
  return (
    <section id="top" className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
      ...
      <div className="container-px mx-auto max-w-[1600px] grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
      ...
      {/* Logo strip */}
      <div className="container-px mx-auto max-w-[1600px] mt-20">
