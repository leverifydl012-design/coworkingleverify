    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description: "Premium coworking space in Rawalpindi offering dedicated desks, private offices, meeting rooms and virtual offices.",
          address: {
            "@type": "PostalAddress",
            streetAddress: "Office#04 Floor, 145 St 3, Civic Center Bahria Town Civic Center Bahria Town",
            addressLocality: "Rawalpindi",
            addressCountry: "PK",
          },
          telephone: "+92-51-8488180",
